...
public class Calculator {
	 ...
	 * 있음 - 단, 입력받는 값이 없을 수도 있고, 결과를 돌려주지 않을 수도 있다 - 하나의 메서드는 한 가지 기능만 수행하도록 작성하는 것이
	 * 좋음(SRP 원칙) - return 반환값이 없는 경우 리턴타입이 void
	 * 
	...
	/*
	 * 인스턴스(객체) 메서드 : 인스턴스 변수나 인스턴스 메서드와 관련된 직업을 하는 메서드 클래스(static) 메서드 : static변수나
	 * static메서드와 관련된 직업을 하는 메서드
	 * 
	 */
	...
	/*
	 * 팩토리얼! 1! =1 2! = 2 x 1 =2 3! = 3 x 2 x 1 =6 n! = n x(n-1) x (n-2) x ...... 1
	 * 
	 */
