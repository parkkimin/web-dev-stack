...
public class B_Time {
	...
	public void method1() {
		...
		System.out.println(now.getDayOfWeek() + "일");
		System.out.println(now.getHour() + "요일");
		System.out.println(now.getYear() + "시");
		...
		localTime = LocalTime.of(17, 59, 59 );
