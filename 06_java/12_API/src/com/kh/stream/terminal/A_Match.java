 ...
 * - noneMatch : allMatch의 반대 
 * */
public class A_Match {
	
	public void method1() {
		int[] values = {2, 4, 6};
		boolean result = Arrays.stream(values).anyMatch(value -> value % 2 == 0);
		...
		System.out.println("모든 수가 다 5의 배수가 아닌가?" + result);
	}
	...
	public void method2() {
		...
		// 남학생들 중에 평균이 90점 이상이 한 명이라도 존재 하는지
