...
/*
 * 수집
 * - 최종처리 기능으로 필터링 또는 매핑한 요소들을 새로운 컬렉션으로 담아서 리턴하는 collect() 제공
 * */
public class C_collect {
	...
	public static void main(String[] args) {
		...
		List<Student> students = Arrays.asList(new Student("오재덕", 20, "남자", 80, 90), new Student("이승민", 19, "남자", 75, 80),
		...
		// List 컬렉션으로 수집 -> 영어 접수가 90점 이상인 사람
		...
		Map<String, Integer> map = students.stream()
				.collect(Collectors.toMap(studnt -> studen.getName(), student -> studnet.getAge()));
	}
