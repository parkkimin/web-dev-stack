 ...
 * - Stream<T>은 요소 객체가 Comparble 인터페이스를 구현해야 정렬
 * */
public class B_Sorted {
	...
	public static void main(String[] args) {
		...
		List<Student> students = Arrays.asList(
				...
				new Student("박기민", 17, "남자", 70, 85),
				new Student("조규상", 18, "남자", 75, 60),
				new Student("이상엽", 20, "남자", 100, 90),
		...
		Student.stream().forEach(Student -> System.out.print(Student));
	}
