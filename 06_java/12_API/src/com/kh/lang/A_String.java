...
public class A_String {
	...
	public void method2() {
		...
		// 문자열의 beginIndex부터 endIndext - 1까지(endIndex 생략하면 끝까지)
		// 의 문자열을 새로 생성해서 리턴
		...
		System.out.println("4.indexOf" + index1);
	...
	public void method3() {
		...
		// 1. append(String str) : StirngBuilder
		// 기본 문자열 뒤에 문자열 추가
		sb.append("Java");
		 ...
		 * - StirngBuffer : 동기화O -> 멀티 스레드 환경 권장 
		 * */
		
		// 메서드 체이님 : 메서드 이어서 쓸 수 있다
	 ...
	 * - 객체 생성시 생성자로 전달바은 문자열을 구분자로 이용하여 분리
	 * - 분리돈 최소 단위를 토큰이라고 부른다
	 * */
