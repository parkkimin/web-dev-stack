...
public class Application {
	...
	public static void main(String[] args) {
		...
		/*
		 * 브랜드, 가격 자유롭게 상관없이, 저 세가지 피자 다 사용!
		 * 
		 * 해당 브랜드의 불고기 피자는 가격은 ~원 피자 반죽과 함께 도우를 빚는다 토핑은 불고기 포함 피자를 180도에서 10분간 구운다 피자를
		 * 8등분 한다 피자를 포장한다
		 *
		 * 
		 * 
		 * 
		 * 해당 브랜드의 파인애플 피자는 가격은 ~원 피자 반죽과 함께 도우를 빚는다 토핑은 불고기 포함 피자를 180도에서 10분간 구운다 피자를
		 * 8등분 한다 피자를 포장한다
		 * 
		 * 
		 * 해당 브랜드의 포테이토 피자는 가격은 ~원 피자 반죽과 함께 도우를 빚는다 토핑은 불고기 포함 피자를 180도에서 10분간 구운다 피자를
		 * 8등분 한다 피자를 포장한다
		 */
	}
